...
echo '<header class="navbar navbar-default fixed-top" style=" height: 75px; box-shadow: none;"> 
    <div class="container-fluid">
        <div class="navb-logo">
            <img src="../images/images/logo.png" alt="logo-needed" class="img-fluid" style="height: 50px;width:250px; ">
        </div>
        ...
        echo '<div id="carouselExampleIndicators" class="carousel slide carousel-fade mt-5" data-ride="carousel" data-interval="4000">';
        ...
        echo '<img src="../images/images/mayora.png" class="d-block w-100" alt="Second slide" draggable="false">';
        echo '</div>';
...
echo ' <div class="main-container">';
   echo '<div class="container-fluid mx-auto mt-3">';
      echo '  <div class="container container-max-width mx-auto mx-3">';
         echo '    <div class="row justify-content-center my-4">';
             ...
             echo '<div class="box-display-popl" style="width: 300px; box-shadow: 3px 3px 0px rgba(2, 61, 0, 1);">';
             ...
             echo '<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12 my-2 d-flex justify-content-center box-display">';
             echo '<div class="box-display-popl" style="width: 300px; box-shadow: 3px 3px 0px rgba(2, 61, 0, 1);">';
             echo '<h4 class="text-start ms-3 mt-3" style="color:black;">Total Males</h4>';
             ...
             echo '<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12 my-2 d-flex justify-content-center box-display">';
             echo '<div class="box-display-popl" style="width: 300px; box-shadow: 3px 3px 0px rgba(2, 61, 0, 1);">';
             echo '<h4 class="text-start ms-3 mt-3" style="color: black;">Total Females</h4>';
             ...
             echo '<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12 my-2 d-flex justify-content-center box-display">';
             echo '<div class="box-display-popl" style="width: 300px; box-shadow: 3px 3px 0px rgba(2, 61, 0, 1);">';
             echo '<h4 class="text-start ms-3 mt-3" style="color:black;">Total Children</h4>';
             ...
             echo '<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12 my-2 d-flex justify-content-center box-display">';
             echo '<div class="box-display-popl" style="width: 300px; box-shadow: 3px 3px 0px rgba(2, 61, 0, 1);">';
             echo '<h4 class="text-start ms-3 mt-3" style="color:black;">Total of Teenagers</h4>';
             ...
             echo '<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12 my-2 d-flex justify-content-center box-display">';
             echo '<div class="box-display-popl" style="width: 300px; box-shadow: 3px 3px 0px rgba(2, 61, 0, 1);">';
             echo '<h4 class="text-start ms-3 mt-3" style="color: black;">Total Adults</h4>';
             ...
             echo '<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12 my-2 d-flex justify-content-center box-display">';
             echo '<div class="box-display-popl" style="width: 300px; box-shadow: 3px 3px 0px rgba(2, 61, 0, 1);">';
             echo '<h4 class="text-start ms-3 mt-3" style="color:black;">Total Seniors</h4>';
...
if (isset($sqlResidents)) {
    ...
    if (isset($_POST['showResidents']) || isset($_POST['searchResidents'])) {
        ...
        if ($selectedBarangayId !== null) {
            ...
            echo "<input type='text' id='ageRangeInput' placeholder='Enter Age Range (e.g., 10-20)' style=' width: 250px; margin-left: 20px; '>";
...
while ($rowBarangays = mysqli_fetch_assoc($resultBarangays)) {
    ...
    switch ($district) {
        case 'District I':
            ...
            echo '<button type="submit" id="editPasswordBtn" name="editPassword" class="btn btn-danger border" style="height: 42px;">Edit Password</button>';
            echo '</form>';
            echo '</td>';
            echo '</tr>';
        }
...
<head>
    ...
    <link href="admin_homepage-styles.css" rel="Stylesheet" type="text/css" /> 
